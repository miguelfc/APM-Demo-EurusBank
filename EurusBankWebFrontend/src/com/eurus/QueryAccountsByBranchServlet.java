 ...
 */
@WebServlet("/queryAccountsByBranch")
public class QueryAccountsByBranchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public QueryAccountsByBranchServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			accountBalance = locator.getqueryAccountsWsHttpSoap11Endpoint().queryAccountsByNameAndBranch("Josete", branch);
